                ...
                <div class="login-main">
                    <div class="input-info">
                        <div class="input-item">
                            ...
                            <input type="text" placeholder="邮箱" name="id">
                        </div>
                        <div class="input-item">
                            <img src="../../static/img/login_logo_password.png" alt="" class="input-icon">
                            <input type="text" placeholder="密码" name="key">
                        </div>
                    </div>
                    ...
                    <div class="wechat">
                        <img src="../../static/img/login_wechat_pressed.png" alt="" class="wechat-icon">
                    </div>
                </div>
                <div class="close">
